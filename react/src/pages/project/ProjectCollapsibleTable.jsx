    ...
    return (
        <React.Fragment>
            <TableRow sx={{ "& > *": { borderBottom: "unset" } }}>
                ...
                <TableCell>
                    <small
                        className={`${row.status === "draft" ? "tw-bg-yellow-500" : row.status === "active" ? "tw-bg-blue-500" : row.status === "archived" ? "tw-bg-red-500" : "tw-bg-green-500"} tw-text-white tw-px-2 tw-py-1 tw-rounded-full`}
                    >
                        {row.status}
                    </small>
                </TableCell>
            ...
            {!loading && (
                <div className="tw-flex tw-justify-end tw-items-center tw-gap-1 tw-my-4 tw-mr-4">
                    <button
                        ...
                        onClick={() => getProjects(pagination.current_page - 1)}
