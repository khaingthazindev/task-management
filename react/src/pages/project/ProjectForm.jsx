...
export default function ProjectForm() {
    ...
    useEffect(() => {
        ...
        axiosClient
            .get(`/projects/${id}`)
            .then(({ data }) => {
                let oldproject = data.data;
                setTasks(oldproject.tasks);

                setProject({
                    id: oldproject.id,
                    title: oldproject.title,
                    description:
                        oldproject.description === null
                            ? undefined
    ...
    const onSubmit = async (e) => {
        ...
        try {
            ...
            if (project.id) {
                await axiosClient.put(`/projects/${project.id}`, payload);
    ...
    const changeDueDate = (date) => {
        ...
        setProject({ ...project, ["due_date"]: formatDate });
    };
